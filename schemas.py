...
# Lead schema for AI video ads startup
class Lead(BaseModel):
    """
    Leads from landing page form
    Collection name: "lead"
    """
    name: str = Field(..., description="Contact name", min_length=2)
    email: EmailStr = Field(..., description="Work email")
    company: Optional[str] = Field(None, description="Company or brand")
    use_case: Optional[str] = Field(None, description="What do you want to create?")
